      ...
      <View style={styles.titleBar}>
                ...
                <View style={{ alignSelf: "center" }}>
                    <View style={styles.profileImage}>
                        <Image source={require("./res.jpg")} style={styles.image} resizeMode="center"></Image>
                    </View>
                ...
                <View style={styles.infoContainer}>
                    <Text style={[styles.text, { fontWeight: "200", fontSize: 36 }]}>Space Bakery</Text>
                    <Text style={[styles.text, { color: "#AEB5BC", fontSize: 14 }]}>09450991607</Text>
                </View>
